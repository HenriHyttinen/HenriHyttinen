...
Includes authentication, order management, admin tooling, security hardening, and containerized deployment. The project focuses on realistic commerce workflows and backend architecture.
